...
public class Booking : Entity
{
    ...
    public Booking(Guid id, Guid apartmentId, Guid userId, DateRange duration, Money priceForPeriod, Money cleaningFee, Money amenitiesUpCharge, Money totalPrice, BookingStatus status, DateTime confirmedOnUtc) : base(id)
    {
    ...
    public Result Cancel(DateTime utcNow)
    {
        ...
        RaiseDomainEvents(new BookingReservedDomainEvent(Id));
